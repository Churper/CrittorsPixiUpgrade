...
function spawnBabyEnemy(critter, app, walkTextures, attackTextures, spawnIndex, typeName) {
  ...
  const lateExtra = Math.min(0.08, (late * 0.002 + late * late * 0.00003) * 0.24);
...
/**
 * Build shared levels for each checkpoint.
 * Simple rule: level = castle + 1 (one level gained per castle cleared).
 */
